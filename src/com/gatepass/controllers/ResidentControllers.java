...
public class ResidentControllers {
    ...
    @PostMapping("/onboard")
    public ResponseEntity<ApiResponse> onboardResident(
            @Valid @RequestBody OnboardResidentRequest request) {
    ...
    public ResponseEntity<ApiResponse> deleteResident(
            @PathVariable String phoneNumber) {

        try {
            return ResponseEntity.ok(
                    new ApiResponse(
                            residentManagementService.deleteResident(phoneNumber),
                            true,
                            null
                    ));
    ...
    public ResponseEntity<ApiResponse> disableResident(
            @PathVariable String phoneNumber) {

        try {
            return ResponseEntity.ok(
                    new ApiResponse(
                            residentManagementService.disableResident(phoneNumber),
                            true,
                            null
                    ));
